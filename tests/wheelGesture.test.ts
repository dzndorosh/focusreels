...
describe('wheel gesture recognizer', () => {
  ...
  it('commits once and ignores momentum until quiet', () => {
    // The quiet period is stated here rather than inherited from the default,
    // so the timings below say what they mean.
    const r = new WheelGestureRecognizer({ quietPeriodMs: 150 });
